...
public class Cloud_Functions
{
    ...
    private static string SERVICE_ACCOUNT_FILE = "fieldsaroundme_desktop_one_key.json"; // Path to your service account JSON file
    ...
    public static string UploadFileToGoogleDrive(string filePath)
    {
        try
        {
            ...
            // File metadata (NO parents field = uploads to root)
            var fileMetadata = new Google.Apis.Drive.v3.Data.File
            {
                Name = fileName,  // Ensures only the file name is used
                MimeType = "text/csv"
            };
